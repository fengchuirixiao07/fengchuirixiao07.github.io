    ...
    <main class="main-content">
        ...
        <div class="posts-container" id="postsContainer">
            ...
            <div class="access-tip">
                <p><i class="fas fa-info-circle"></i> 点击文章卡片将在新标签页中打开文章页面</p>
            </div>
            
            <!-- 第一篇文章链接 - 跳转到 basic-crypto.html -->
            <a href="https://fengchuirixiao07.github.io/basic-crypto.html" target="_blank" class="post-link-card">
                <div class="post-icon">
                ...
                <div class="post-link-content">
                    ...
                    <div class="post-link-meta">
                        <i class="fas fa-external-link-alt"></i> 点击在新窗口阅读完整文章
                    </div>
                </div>
            </a>
            
            <!-- 第二篇文章链接 - 跳转到 three-week.html -->
            <a href="https://fengchuirixiao07.github.io/three-week.html" target="_blank" class="post-link-card">
                <div class="post-icon">
            ...
            <!-- 第三篇文章链接 - CTF密码学解析 -->
            <a href="https://fengchuirixiao07.github.io/ctf-crypto.html" target="_blank" class="post-link-card">
                <div class="post-icon">
                    <i class="fas fa-shield-alt"></i>
                </div>
                <div class="post-link-content">
                    <h3 class="post-link-title">CTF密码学题目解析</h3>
                    <p class="post-link-description">详细解析了多个CTF密码学题目，包括ROT移位密码、摩斯密码、凯撒密码、RSA加密、dp泄露攻击、共模攻击等经典密码学题目和解题思路。</p>
                    <div class="post-link-meta">
                        <i class="fas fa-external-link-alt"></i> 点击在新窗口阅读完整文章
                    </div>
                </div>
        ...
        <footer class="footer">
            <div class="footer-content">
                ...
                <p class="copyright" style="margin-top: 10px; font-size: 12px;">
                    托管于 <a href="https://fengchuirixiao07.github.io/" target="_blank" style="color: #ddd;">GitHub Pages</a>
                </p>
            </div>
        </footer>
    </main>
