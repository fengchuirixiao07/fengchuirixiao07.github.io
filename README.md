...
<body>
    ...
    <main class="main-content">
        ...
        <div class="posts-container" id="postsContainer">
            ...
            <!-- 第一篇文章链接 -->
            <div class="post-link-card" data-article="article1">
                <div class="post-icon">
                ...
                <div class="post-link-content">
                    ...
                    <div class="post-link-meta">
                        <i class="fas fa-book-open"></i> 点击在页面内阅读
                    </div>
                </div>
            </div>
            
            <!-- 第二篇文章链接 -->
            <div class="post-link-card" data-article="article2">
                <div class="post-icon">
        ...
        <div class="article-container" id="article1Container">
            <button class="back-to-posts" onclick="showPosts()">
